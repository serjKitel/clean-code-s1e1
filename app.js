...
var createNewTaskElement=function(taskString){
    ...
    editButton.className="button button_edit-task";

    deleteButton.className="button button_delete-task";
...
var editTask=function(){
    ...
    var editBtn=listItem.querySelector(".button_edit-task");
...
//select ListItems children
    ...
    var editButton=taskListItem.querySelector("button.button_edit-task");
    var deleteButton=taskListItem.querySelector("button.button_delete-task");
